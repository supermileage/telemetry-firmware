...
BmsManager::BmsManager(CanSensorBms** bmsPtr, CanSensorBms* orion, BmsOption option) : _mainBmsPtr(bmsPtr), _orion(orion), _currentOption(option) {
	setBms(option);
}
